...
$PostMessageResults = [
  ...
  POST_MESSAGE_RESULT_FAILED_ERROR => "failed_type이 아닌 경우에 실패 SMS 제목과 내용이 없으면 에러",
...
class TKakaoNotificationTalk {
  ...
  private $key = "MTQ0MjAtMTYxNTg4MTMyOTgxMi1kMzVjNGM2NS00NGZhLTQ5NTAtOWM0Yy02NTQ0ZmE5OTUwMDA="; // "고객 키"
  public $client_id = "olivejnainc"; // {client_id}
  public $defaultCallBack = "0518055957"; // 기본 회신 연락처
