...
<div id="payment" class="woocommerce-checkout-payment">
	<h3 style="font-size:1.7rem; color:#202020;text-align:left; font-family:s-core-dream-heavy;letter-spacing:-2.5px; line-height:1.2;display:block; margin-bottom:20px;">결제수단</h3>
	<!-- 탭버튼은 아래에 있는것을 수정하자 -->
