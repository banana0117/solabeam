...
<script>
    ...
    $("input[name='radio_choice_opt_pot']").hide();
    $("input[name='radio_choice_opt_multipot']").hide();
    $("input[name='radio_choice_opt_maker']").hide();
    $("input[name='radio_choice_opt_snack']").hide();
    $("input[name='radio_choice_table']").hide();
    $("input[name='radio_choice_opt_counter']").hide();
