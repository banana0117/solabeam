...
/**
 * Template Name: con3survey-sub
 */

get_header(); ?>

<div class="section">
    <!-- 여기 액션에 con3미니보고서 링크를 적어주시면 됩니다 -->
    <form action="/con3report" method="POST" id="presearch">
        <div class="survey fade sur_01 survey01">
            ...
            <div class="survey-sub-contents ps20">
                <div class="survey-title">
                    <h4>우리아기,<br>잘 자라고 있을까? <br>
                        <p>아기 성장을 체크하는 미니 보고서와 맞춤 이유식 식단을 확인해 보세요!</p>
                    </h4>
                    <a href="#none" class="pp">설문조사 전, 이유식 시작 <br>체크리스트를 확인해 주세요! ></a>
                </div>
            </div>
            <div class="btn bg-ff ms20" id="pppp">
            ...
            <div class="servey">
                ...
                <div class="servey-main ps20">
                    ...
                    <div class="age">
                        <p>고객님의 연령대를 알려주세요.</p>
                        <div class="radio">
                            <input type="radio" name="ages" id="age20" value="20">
                            <label for="age20">만 20세 미만</label>
                            <input type="radio" name="ages" id="age25" value="25">
                            <label for="age25">만 20~25세 미만</label>
                            <input type="radio" name="ages" id="age30" value="30">
                            <label for="age30">만 25~30세 미만</label>
                            <input type="radio" name="ages" id="age35" value="35">
                            <label for="age35">만 30~35세 미만</label>
                            <input type="radio" name="ages" id="age40" value="40">
                            <label for="age40">만 35~40세 미만</label>
                            <input type="radio" name="ages" id="age40up" value="45">
                    ...
                    <div class="kg">
                        <p>현재 체중 kg</p>
                        <input type="text" name="kg" id="rekg" placeholder="숫자만 입력해주세요. kg" value="kg">
                        <label for="rekg"></label>
                    </div>
                    <div class="alarm">
                        <div class="alarm-title">
                            <img src="/wp-content/themes/storefront-child/con3/image/Group 258.png" alt="">
                            <h5>도담알림</h5>
                        </div>
                        <p>다음 설문조사는 이유식 시기 추천을 위한 설문조사입니다.</p>
                        <p>이유식 시기를 추천 받지 않고 식단 추천만 받고 싶은 분은 원하는 시기를 선택하신 후에 <b>[식단 추천 바로가기]</b>를 눌러주세요.</p>
                    </div>
                    <div class="star-time">
                        <p>이유식 시작 시기를 선택해주세요.</p>
                        <div class="radio">
                            <input type="radio" name="time" id="jun" value="jun">
                            <label for="jun">준비기</label>
                            <input type="radio" name="time" id="cho" value="cho">
                            <label for="cho">초기</label>
                            <input type="radio" name="time" id="jung" value="jung">
                            <label for="jung">중기</label>
                            <input type="radio" name="time" id="hu" value="hu">
                            <label for="hu">후기</label>
                            <input type="radio" name="time" id="wan" value="wan">
                            <label for="wan">완료기</label>
                        </div>
                    </div>
                    <div class="time-go btn">
                        <h5>시기 추천 받기 ></h5>
                    </div>
                    <div class="food-go btn">
                        <h5>식단 추천 바로가기 ></h5>
                    </div>
                </div>
            </div>
        ...
        <div class="survey-sub fade sur_03">
            ...
            <div class="prograp">
                <div class="prograp-bar percent14"></div>
            </div>
            <div class="survey-sub-contents ps20">
                <p>1.현재 이유식을 진행하고 있나요?</p>
                <div class="radio">
                    <input type="radio" name="ing" id="no" value="없어요">
                    <label for="no">진행한 적 없어요.</label>
                    <input type="radio" name="ing" id=yes value="있어요">
                    <label for="yes">진행하고 있어요.</label>
                    <!-- <input type="radio" name="ing" id=yoo-go value="유아식">
            <label for="yoo-go">유아식을 진행하고 있어요. </label> -->
                </div>
            </div>
        </div>
        <!-- page02 -->
        <div class="survey-sub fade">
            ...
            <div class="prograp">
                <div class="prograp-bar percent28"></div>
            </div>
            <div class="survey-sub-contents ps20">
                <p>2. 이유식을 시작한 지 얼마나 되었나요?</p>
                <div class="radio">
                    <input type="radio" name="start-dodam" id="no-week" value="아직">
                    <label for="no-week">아직 4주가 안되었어요.</label>
                    <input type="radio" name="start-dodam" id=yes-week value="넘었다">
                    <label for="yes-week">이유식을 시작하지 4주가 넘었어요.</label>
                </div>
            </div>
        </div>
        <!-- page03 -->
        <div class="survey-sub fade sur_05">
            <div class="step">
                <ul>
                    <li>기본정보</li>
                    <li><img src="/wp-content/themes/storefront-child/con3/image/Arrow1.png" alt="Arrow1"></li>
            ...
            <div class="prograp">
                <div class="prograp-bar percent42"></div>
            </div>
            <div class="survey-sub-contents ps20">
                <p>3. 육류 이유식을 먹여 보았나요?</p>
                <div class="radio">
                    <input type="radio" name="eat" id="no-eat" value="안먹었다">
                    <label for="no-eat">아직 먹여보지 않았어요.</label>
                    <input type="radio" name="eat" id=yes-eat value="먹였다">
                    <label for="yes-eat">먹여 보았어요.</label>
                </div>
            </div>
        </div>
        <!-- page04 -->
        <div class="survey-sub fade">
            ...
            <div class="prograp">
                <div class="prograp-bar percent56"></div>
            </div>
            <div class="survey-sub-contents ps20">
                <p>4. 곡류 외에 2가지 이상의 재료를 혼합해서 먹인 적이 있나요? <br> <span>(예시: 애호박양배추미음, 쇠고기애호박미음)</span></p>

                <div class="radio">
                    <input type="radio" name="mix" id="no-mix" value="혼합아직">
                    <label for="no-mix">아직 혼합해서 먹인 적은 없어요.</label>
                    <input type="radio" name="mix" id=yes-mix value="혼합먹음">
                    <label for="yes-mix">혼합해서 먹인 적이 있어요.</label>
                </div>
            </div>
        </div>
        <!-- page05 -->
        <div class="survey-sub fade">
            ...
            <div class="prograp">
                <div class="prograp-bar percent70"></div>
            </div>
            <div class="survey-sub-contents ps20">
                <p>5. 하루 이유식 섭취 횟수를 알려주세요.</p>
                <div class="radio">
                    <input type="radio" name="foods" id="food-one" value="한번">
                    <label for="food-one">한 번 섭취해요.</label>
                    <input type="radio" name="foods" id=food-two value="두번">
                    <label for="food-two">두 번 섭취해요..</label>
                    <input type="radio" name="foods" id=food-thr value="세번">
                    <label for="food-thr">세 번 섭취해요.</label>
                </div>
            </div>
        </div>
        <!-- page06 -->
        <div class="survey-sub fade">
            ...
            <div class="prograp">
                <div class="prograp-bar percent84"></div>
            </div>
            <div class="survey-sub-contents ps20">
                <p>6. 아기가 한 번에 먹는 이유식 섭취량을 알려주세요. <br><span>(최근 일주일 평균 섭취량을 입력해 주세요.)</span></p>
                <div class="radio">
                    <select name="one-time" id="one-retime">
                        <option value="0">먹여보지 않음</option>
        ...
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                <p>7. 입자감이 있는 이유식을 먹어 보았나요?</p>
                <div class="radio">
                    <input type="radio" name="big-fd" id="big-fd01" value="아직">
                    <label for="big-fd01">아직 먹어보지 않았어요.</label>
                    <input type="radio" name="big-fd" id="big-fd02" value="시도">
                    <label for="big-fd02">시도해보았지만 잘 먹지 못했어요.</label>
                    <input type="radio" name="big-fd" id="big-fd03" value="4주이하">
                    <label for="big-fd03">입자감 있는 이유식을 시작한지 4주가 안되었어요.</label>
                    <input type="radio" name="big-fd" id="big-fd04" value="4주이상">
                    <label for="big-fd04">입자감 있는 이유식을 시작한지 4주 이상 지났어요.</label>
                </div>
            </div>
        </div>
        <!-- page08 -->
        <div class="survey-sub fade sur_04 d-date">
            <div class="step">
                <ul>
                    <li>기본정보</li>
                    <li><img src="/wp-content/themes/storefront-child/con3/image/Arrow1.png" alt="Arrow1"></li>
            ...
            <div class="survey-sub-contents ps20">
                <p>1. 현재 수유는 어떻게 진행하고 계신가요? <br><span>(수유량은 최근 일주일 평균치로 작성해주세요.)</span></p>
                <div class="select">
                    <input type="radio" name="average" id="average01" value="완모">
                    <label for="average01">완모</label>
                    <select name="averages" id="average-sel01">
                        <option value="30">30ml</option>
                        <option value="40">40ml</option>
                        <option value="50">50ml</option>
                        <option value="60">60ml</option>
                    ...
                    <input type="radio" name="average" id="average02" value="완분">
                    <label for="average02">완분</label>
                    <select name="averages" id="average-sel02">
                        <option value="30">30ml</option>
                        <option value="40">40ml</option>
                        <option value="50">50ml</option>
                        <option value="60">60ml</option>
                    ...
                    <input type="radio" name="average" id="average03" value="혼합">
                    <label for="average03">혼합수유</label>
                    <select name="averages" id="average-sel03">
                        <option value="30">30ml</option>
                        <option value="40">40ml</option>
                        <option value="50">50ml</option>
                        <option value="60">60ml</option>
        ...
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                <p>2. 현재 이유식을 진행하고 있다면, 아래 문항에 답해주세요. <br><span>(복수 선택 가능)</span></p>
                <div class="checkbox showSlide8">
                    <input type="checkbox" name="cooking[]" id=cooking01 value="직접">
                    <label for="cooking01">직접 조리</label>
                    <input type="checkbox" name="cooking[]" id=cooking02 value="시판">
                    <label for="cooking02">시판 이유식</label>
                    <input type="checkbox" name="cooking[]" id=cooking03 value="배달">
                    <label for="cooking03">배달 이유식</label>
                    <input type="checkbox" name="cooking[]" id=cooking04 value="분말">
                    <label for="cooking04">분말 이유식</label>
                    <input type="checkbox" name="cooking[]" id=cooking05 value="기타">
                    <label for="cooking05">기타</label>
                </div>
            </div>
        </div>
        <!-- page10 -->
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                <p>2-1. 아기가 한 번에 먹는 이유식 섭취량을 알려주세요. <br><span>(최근 일주일 평균 섭취량을 입력해 주세요.)</span></p>
                <div class="radio">
        ...
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                ...
                <div class="select gogo">
                    ...
                    <input type="radio" name="impo" id="impo02" value="재료">
                    <label for="impo02">최대한 많은 재료를 다양하게 먹이고 싶어요.</label>
                    <input type="radio" name="impo" id="impo03" value="한우">
                    ...
                    <input type="radio" name="impo" id="impo05" value="마음대로">
                ...
                <div class="popup-sub">
                    <div class="container">
                        <div class="pop-list_01">
                            <h5>변비</h5>
                            <img src="/wp-content/themes/storefront-child/con3/image/Frame.png" alt="Arrow1">
                            <div class="checkbox checkbox-one ps20" id="radio_01">
                                <input type="checkbox" id="const01" name="sick001[]" value="변원">
                                <label for="const01">병원에서 변비 진단을 받았어요.</label>
                                <input type="checkbox" id="const02" name="sick001[]" value="불록">
                                <label for="const02">배가 불록하고 단단한테, 변을 보지 않아요.</label>
                                <input type="checkbox" id="const03" name="sick001[]" value="단단">
                                <label for="const03">굵고 단단한 변이 나와요.</label>
                                <input type="checkbox" id="const04" name="sick001[]" value="항문">
                                <label for="const04">항문에 피가 묻어나와요.</label>
                                <input type="checkbox" id="const05" name="sick001[]" value="화장실">
                                <label for="const05">화장실을 가기 싫어하고,배변 시 불편해하거나 아파해요.</label>
                                <input type="checkbox" id="const06" name="sick001[]" value="배변">
                ...
                <div class="popup-sub">
                    <div class="container">
                        <div class="pop-list_02">
                            <h5>설사</h5>
                            <img src="/wp-content/themes/storefront-child/con3/image/Frame.png" alt="Arrow1">
                            <div class="checkbox checkbox-one ps20" id="radio_02">
                                <input type="checkbox" id="diarrhea01" name="sick002[]" value="설사">
                                <label for="diarrhea01">병원에서 설사 진단을 받았어요.</label>
                                <input type="checkbox" id="diarrhea02" name="sick002[]" value="장염">
                                <label for="diarrhea02">장염, 식중독 등 특정 질환 때문에 설사를 해요.</label>
                                <input type="checkbox" id="diarrhea03" name="sick002[]" value="묽은">
                                <label for="diarrhea03">하루 평균 3회 이상 묽은 변이 나와요.</label>
                                <input type="checkbox" id="diarrhea04" name="sick002[]" value="체중">
                ...
                <div class="popup-sub">
                    <div class="container">
                        <div class="pop-list_03">
                            <h5>구역질,구토</h5>
                            <img src="/wp-content/themes/storefront-child/con3/image/Frame.png" alt="Arrow1">
                            <div class="checkbox checkbox-one ps20" id="radio_03">
                                <input type="checkbox" id="goo01" name="sick003">
                ...
                <div class="popup-sub">
                    <div class="container">
                        <div class="pop-list_04">
                            <h5>발열</h5>
                            <img src="/wp-content/themes/storefront-child/con3/image/Frame.png" alt="Arrow1">
                            <div class="checkbox checkbox-one ps20" id="radio_04">
                                <input type="checkbox" id="foot01" name="sick004[]" value="감기">
                                <label for="foot01">감기, 폐렴 등 특정 질환때문에 열이 나요.</label>
                                <input type="checkbox" id="foot02" name="sick004[]" value="액와">
                                <label for="foot02">액와(겨드랑이 안쪽) 부위 체온이 37.4℃ 이상이에요.</label>
                                <input type="checkbox" id="foot03" name="sick004[]" value="구강">
                                <label for="foot03">구강 또는 고막 체온이 37.6℃ 이상이에요.</label>
                                <input type="checkbox" id="foot04" name="sick004[]" value="체온">
        ...
        <div class="survey-sub fade showSlide-yoo">
            ...
            <div class="survey-sub-contents ps20">
                <p>1. 유아식 진행 방법을 알려주세요.</p>
                <div class="checkbox showSlide15">
                    ...
                    <label for="recooking02">시판 유아식</label>
                    <input type="checkbox" name="recooking[]" id=recooking03 value="배달">
                    <label for="recooking03">배달 유아식</label>
                    <input type="checkbox" name="recooking[]" id=recooking04 value="분말">
                    <label for="recooking04">분말 유아식</label>
                    <input type="checkbox" name="recooking[]" id=recooking05 value="기타">
                    <label for="recooking05">기타</label>
                    <input type="checkbox" name="recooking[]" id=recooking06 value="시작전">
                    <label for="recooking06">이유식 시작전</label>
                    <p>(현재 이유식을 시작중이고 아직 유아식 시작 전이라면, <span>[문항 넘어가기]</span> 버튼을 눌러주세요)</p>
                </div>
            </div>
        </div>
        <!-- page18 -->
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                <p>2. 아이가 한 번에 먹는 이유식 섭취량을 알려주세요. <br><span>(최근 일주일 평균 섭취량을 입력해 주세요.)</span></p>
                <div class="radio">
        ...
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                <p>3. 현재 수유 중이시라면 하루 총 수유량을 알려주세요.<br><span>(최근 일주일 평균 섭취량을 입력해 주세요.)</span></p>
                <div class="radio">
        ...
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                <p>4. 현재 유아식 진행 중이시라면 한 번에 먹는 밥 섭취량을 알려주세요.<br><span>(최근 일주일 평균 섭취량을 입력해 주세요.)</span></p>
        ...
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                <p>5. 우리 아이 유아식 식단에서 가장 중요하게 생각하는 부분은 어떤 것인가요?</p>
                <div class="select gogo">
                    <input type="radio" name="impo-you" id=impo-you01 value="재료">
                    <label for="impo-you01">최대한 많은 재료를 다양하게 먹이고 싶어요.</label>
                    <input type="radio" name="impo-you" id=impo-you02 value="한우">
                    <label for="impo-you02">신선한 한우를 매일 먹이고 싶어요.</label>
                    <input type="radio" name="impo-you" id=impo-you03 value="가성비">
                    <label for="impo-you03">꼭 필요한 것만 챙겨서 가성비 좋은 유아식을 먹이고 싶어요.</label>
                    <input type="radio" name="impo-you" id=impo-you04 value="마음대로">
                    <label for="impo-you04">내 마음대로 우리 아기에게 맞춰서 식단을 구성하고 싶어요.</label>
                </div>
            </div>
        </div>
        <!-- page22 -->
        ...
        <div class="survey-sub fade">
            ...
            <div class="survey-sub-contents ps20">
                <p>2. 다음 중 최근 한 달 사이에 자주 나타난 증상이 있나요?</p>
                <div class="radio radio-two">
                ...
                <div class="popup-sub">
                    <div class="container">
                        <div class="pop-list_01">
                            ...
                            <img src="/wp-content/themes/storefront-child/con3/image/Frame.png" alt="Arrow1">
                            <div class="checkbox checkbox-one ps20" id="radio_01">
                                <input type="checkbox" id="con-sick01" name="con-sick[]" value="병원">
                                <label for="con-sick01">병원에서 변비 진단을 받았어요.</label>
                                <input type="checkbox" id="con-sick02" name="con-sick[]" value="배">
                                <label for="con-sick02">배가 불록하고 단단한테, 변을 보지 않아요.</label>
                                <input type="checkbox" id="con-sick03" name="con-sick[]" value="굵고">
                                <label for="con-sick03">굵고 단단한 변이 나와요.</label>
                                <input type="checkbox" id="con-sick04" name="con-sick[]" value="항문">
                                <label for="con-sick04">항문에 피가 묻어나와요.</label>
                                <input type="checkbox" id="con-sick05" name="con-sick[]" value="화장실">
                                <label for="con-sick05">화장실을 가기 싫어하고,배변 시 불편해하거나 아파해요.</label>
                                <input type="checkbox" id="con-sick06" name="con-sick[]" value="배변">
                ...
                <div class="popup-sub">
                    <div class="container">
                        <div class="pop-list_02">
                            ...
                            <img src="/wp-content/themes/storefront-child/con3/image/Frame.png" alt="Arrow1">
                            <div class="checkbox checkbox-one ps20" id="radio_02">
                                <input type="checkbox" id="diarsick01" name="diarsick[]" value="병원">
                                <label for="diarsick01">병원에서 변비 진단을 받았어요.</label>
                                <input type="checkbox" id="diarsick02" name="diarsick[]" value="장염">
                                <label for="diarsick02">장염, 식중독 등 특정 질환 때문에 설사를 해요.</label>
                                <input type="checkbox" id="diarsick03" name="diarsick[]" value="하루">
                                <label for="diarsick03">하루 평균 3회 이상 묽은 변이 나와요.</label>
                                <input type="checkbox" id="diarsick04" name="diarsick[]" value="대변량">
                ...
                <div class="popup-sub">
                    <div class="container">
                        <div class="pop-list_03">
                            ...
                            <img src="/wp-content/themes/storefront-child/con3/image/Frame.png" alt="Arrow1">
                            <div class="checkbox checkbox-one ps20" id="radio_03">
                                <input type="checkbox" id="goo-sick01" name="goo-sick">
                ...
                <div class="popup-sub">
                    <div class="container">
                        <div class="pop-list_04">
                            ...
                            <img src="/wp-content/themes/storefront-child/con3/image/Frame.png" alt="Arrow1">
                            <div class="checkbox checkbox-one ps20" id="radio_04">
                                <input type="checkbox" id="foot-sick01" name="foot-sick[]" value="감기">
                                <label for="foot-sick01">감기, 폐렴 등 특정 질환때문에 열이 나요.</label>
                                <input type="checkbox" id="foot-sick02" name="foot-sick[]" value="액와">
                                <label for="foot-sick02">액와(겨드랑이 안쪽) 부위 체온이 37.4℃ 이상이에요.</label>
                                <input type="checkbox" id="foot-sick03" name="foot-sick[]" value="구강">
                                <label for="foot-sick03">구강 또는 고막 체온이 37.6℃ 이상이에요.</label>
                                <input type="checkbox" id="foot-sick04" name="foot-sick[]" value="항문">
        ...
        <div class="survey-sub fade showSlide-last">
            <div class="survey-sub-contents ps20">
                <div class="sur-header">
                    <p>답변 내용을 <br> 분석하고 있습니다.<br>
                    <p class="sur-p">답변해주신 내용을 바탕으로 우리 아기에게 꼭 맞는 식단을 추천해드립니다.</p>
                    </p>
                </div>
            </div>
            <div class="loding-img">
                <img src="/wp-content/themes/storefront-child/con3/image/loding.png" alt="loding">
            </div>
...
<script>
    ...
    input01.click(function() {
        ...
        if (inpch01) {
            ...
            $("input:checkbox[name = 'sick001']").prop("checked", false);
        }
    });
    ...
    input02.click(function() {
        ...
        if (inpch02) {
            ...
            $("input:checkbox[name = 'sick002']").prop("checked", false);
        }
    });
    ...
    input03.click(function() {
        ...
        if (inpch03) {
            ...
            $("input:checkbox[name = 'sick003']").prop("checked", false);
        }
    });
    ...
    input04.click(function() {
        ...
        if (inpch04) {
            ...
            $("input:checkbox[name = 'sick004']").prop("checked", false);
        }
    });
</script>
<!--  팝업2 -->
<script>
    ...
    input001.click(function() {
        ...
        if (inpch001) {
            ...
            $("input:checkbox[name = 'con-sick']").prop("checked", false);
        }
    });
    ...
    input002.click(function() {
        ...
        if (inpch002) {
            ...
            $("input:checkbox[name = 'diarsick']").prop("checked", false);
        }
    });
    ...
    input003.click(function() {
        ...
        if (inpch003) {
            ...
            $("input:checkbox[name = 'goo-sick']").prop("checked", false);
        }
    });
    ...
    input004.click(function() {
        ...
        if (inpch004) {
            ...
            $("input:checkbox[name = 'foot-sick']").prop("checked", false);
        }
    });
</script>
<script>
...
<script>
    ...
    $(".sur_04").on("click", function() {

        var tr = $("input[name = 'average']").prop("checked", true);
        var Dday = new Date($('#redate').val());
        var now = new Date();
        var gap = now.getTime() - Dday.getTime();
        var result = Math.floor(gap / (1000 * 60 * 60 * 24)) * 1;
