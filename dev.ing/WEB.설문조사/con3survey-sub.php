    ...
    <form action="">
        ...
        <div class="survey-sub-contents ps20">
            <div class="survey-title">
                <h4>우리아기,<br>잘 자라고 있을까? <br><p>아기 성장을 체크하는 미니 보고서와 맞춤 이유식 식단을 확인해 보세요!</p></h4>
...
<div class="survey-sub fade sur_04 d-date">
    ...
    <div class="survey-sub-contents ps20">
        ...
        <div class="select">
            <input type="radio" name="average" id="average01"> 
            <label for="average01">완모</label>
            <select name="average" id="average-sel01">
                    <option value="30">30ml</option>
                    <option value="40">40ml</option>
                    <option value="50">50ml</option>
                    <option value="60">60ml</option>
            ...
            <input type="radio" name="average" id="average02">
            <label for="average02">완분</label>
            <select name="average" id="average-sel02">
                    <option value="30">30ml</option>
                    <option value="40">40ml</option>
                    <option value="50">50ml</option>
                    <option value="60">60ml</option>
            ...
            <input type="radio" name="average" id="average03">
            <label for="average03">혼합수유</label>
            <select name="average" id="average-sel03">
                    <option value="30">30ml</option>
                    <option value="40">40ml</option>
                    <option value="50">50ml</option>
                    <option value="60">60ml</option>
                ...
                <div class="container">
                    <div class="pop-list_02">
                        ...
                        <div class="checkbox checkbox-one ps20" id="radio_02">
                            <input type="checkbox" id="diarrhea01" name="sick002[]" value="변비">
                            <label for="diarrhea01">병원에서 변비 진단을 받았어요.</label>
...
<div class="survey-sub fade">
    ...
    <div class="survey-sub-contents ps20">
        <p>2. 아이가 한 번에 먹는 유아식 섭취량을 알려주세요. <br><span>(최근 일주일 평균 섭취량을 입력해 주세요.)</span></p>
        <div class="radio">
...
<div class="survey-sub fade">
    ...
    <div class="survey-sub-contents ps20">
        ...
        <div class="select select-you">
            ...
            <select name="average-you" id="average-you03">
                    <option value="30">30ml</option>
                    <option value="40">40ml</option>
                    <option value="50">50ml</option>
                    <option value="60">60ml</option>
                ...
                <div class="container">
                    <div class="pop-list_03">
                        ...
                        <div class="checkbox checkbox-one ps20" id="radio_03">
                            ...
                            <div class="goo02">
                                <p>구토 횟수</p>
                                <select name="goo-sick" id="goo-sick02">
                                    <option value="1">1회/하루</option>
                                    <option value="2">2회/하루</option>
                                    <option value="3">3회/하루</option>
                                    <option value="4">4회/하루</option>
                            ...
                            <div class="goo03">
                                <p>주로 식후&nbsp;</p>
                                <select name="goo-sick" id="goo-sick03">
                                    <option value="10">10분</option>
                                    <option value="20">20분</option>
                                    <option value="30">30분</option>
                                    <option value="40">40분</option>
