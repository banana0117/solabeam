    ...
    <div class="servey-main ps20">
        ...
        <div class="alarm">
            <div class="alarm-title">
                <img src="/wp-content/themes/storefront-child/con3/image/Group_258.png" alt="">
                <h5>도담알림</h5>
            </div>
        ...
        <div class="radio radio-food-go">
            ...
            <div class="time-go btn btn-type01">
                <h5>시기 추천 받기 ></h5>
            </div>
...
<!-- page07 -->
<div class="survey-sub fade sur_04">
    <div class="step">
        <ul>
            <li>기본정보</li>
            <li><img src="/wp-content/themes/storefront-child/con3/image/Arrow1.png" alt="Arrow1"></li>
...
<!-- page08 -->
<!-- 수정 -->
<div class="survey-sub fade d-date">
    <div class="step">
        <ul>
            <li>기본정보</li>
            <li><img src="/wp-content/themes/storefront-child/con3/image/Arrow1.png" alt="Arrow1"></li>
    ...
    <div class="survey-sub-contents ps20">
        <p>1. 현재 이유식을 진행하고 있다면, 아래 문항에 답해주세요. <span>(복수 선택 가능)</span><br>
            <span>(아직 이유식 시작 전이라면, <span class="pspan">[다음 문항 바로 가기]</span> 버튼을 눌러주세요)</span>
        </p>
        <div class="checkbox page08">
            <input type="checkbox" nmae="average44[]" id="average01">
            <label for="average01">직접 조리</label>
            <input type="checkbox" nmae="average44[]" id="average02">
            <label for="average02">시판, 배달 이유식 이용</label>
            <input type="text" name="average44[]" id="average02-01" placeholder="업체명을 입력해주세요.">
            <input type="checkbox" name="average44[]" id="average03">
            <label for="average03">분말 이유식 이용</label>
            <input type="text" name="average44[]" id="average03-01" placeholder="업체명을 입력해주세요.">
            <input type="checkbox" name="average44[]" id="average04">
            <label for="average04">혼합 진행</label>
            <input type="text" name="average44[]" id="average04-01">
            <input type="checkbox" name="average44[]" id="average05">
            <label for="average05">기타</label>
            <input type="text" name="average44" id="average05-01">
        </div>
        </div>
    </div>
</div>
...
<div class="survey-sub fade">
    ...
    <div class="survey-sub-contents ps20 page11">
        ...
        <div class="select">
            ...
            <select name="reselect002" id="select006">
                    <option value="30">30ml</option>
                    <option value="40">40ml</option>
                    <option value="50">50ml</option>
                    <option value="60">60ml</option>
            ...
            <input type="text" name="reselect-t" id="select011">
        </div>
    </div>
    </div>
</div>
...
<div class="survey-sub fade">
    ...
    <div class="survey-sub-contents ps20">
        ...
        <div class="select">
        <input type="radio" name="su-you" id="su-yoo01">
        <label for="su-yoo01">수유중</label>
        <select name="su-you01" id="su-you">
            <option value="30">30ml</option>
            <option value="40">40ml</option>
            <option value="50">50ml</option>
            <option value="60">60ml</option>
        ...
        <input type="radio" name="su-you" id="su-yoo02">
