...
<div class="shop_table woocommerce-checkout-review-order-table">
    <div>
        <div class="bill-title-head">
            <div class="">
                <p>주문상품</p>
            </div>
        </div>
        <div class="per-detail" id="meal_detail">
            <!--시기별사진-->
            <div class="per-detail-img">
                <img id="period_img" src="/wp-content/themes/storefront-child/con3/image/test-test.png">
            </div>
            <!--시기, 식단명, 가격등 -->
            <div class="per-detail-inner">
                <?php //건드리지마세용
                ...
                <div class="per-detail-start">
                    <p id="deli-start"></p>
                </div>
                <div class="per-detail-end">
                    <p id="deli-end"></p>
                </div>
                <div class="per-detail-day">
                    <p id="deli-day"></p>
                </div>
            </div>
            <!--옵션라인 -->
