...
<div id="payment" class="woocommerce-checkout-payment">
	<h3 class="pay-text" style="font-size:1.7rem; color:#202020;text-align:left; font-family:s-core-dream-heavy;letter-spacing:-2.5px; line-height:1.2;display:block; margin-bottom:20px;">결제수단</h3>
	<!-- 탭버튼은 아래에 있는것을 수정하자 -->
	<div class="pay-title" style="display:flex;">
		<div class="on" id="subtab" style="justify-content:space-between;">
			<p>카드결제</p>
		</div>
		<div class="" id="kakaotab" style="justify-content:space-between;">
			<p>카카오페이</p>
		</div>
	</div>
	<script>
